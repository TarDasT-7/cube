 ...
 * Original file: /gh/ivorpad/mediaelement-changespeed@master/changespeed.js
 *
 * Do NOT use SRI with dynamically generated files! More information: https://www.jsdelivr.com/using-sri-with-dynamic-files
 */
 "use strict";mejs.i18n.en["mejs.speed-rate"]="Speed Rate",Object.assign(mejs.MepDefaults,{speeds:["2.00","1.50","1.25","1.00","0.75"],defaultSpeed:"1.00",speedChar:"x",speedText:null}),Object.assign(MediaElementPlayer.prototype,{buildchangespeed(e,t,s,n){const o=this;let a,p=!1,d=[],l=mejs.Utils.isString(o.options.speedText)?o.options.speedText:mejs.i18n.t("mejs.speed-rate");for(let e=0,t=o.options.speeds.length;e<t;e++){const t=o.options.speeds[e];"string"==typeof t?(d.push({name:`${t}${o.options.speedChar}`,value:t}),t===o.options.defaultSpeed&&(p=!0)):(d.push(t),t.value===o.options.defaultSpeed&&(p=!0))}let i;p||d.push({name:o.options.defaultSpeed+o.options.speedChar,value:o.options.defaultSpeed}),a=o.options.defaultSpeed,d=d.sort((function(e,t){return parseFloat(e.value)-parseFloat(t.value)})),i=d.findIndex((function(e){return e.value===o.options.defaultSpeed})),o.cleanchangespeed(e);var r;e.speedButton=document.createElement("div"),e.speedButton.className=`${o.options.classPrefix}button ${o.options.classPrefix}speed-button`,e.speedButton.innerHTML=(r=(e=>{for(let t=0,s=d.length;t<s;t++)if(d[t].value===e)return d[t].name})(o.options.defaultSpeed),`<button type="button" aria-controls="${o.id}" title="${l}" aria-label="${l}" tabindex="0">${r}</button>`),o.addControlElement(e.speedButton),e.speedButton.addEventListener("click",(function(){i++,i%=d.length,n.playbackRate=parseFloat(d[i].value),this.firstElementChild.innerText=d[i].value+o.options.speedChar})),n.addEventListener("loadedmetadata",(()=>{a&&(n.playbackRate=parseFloat(a))}))},cleanchangespeed(e,t,s,n){e&&(e.speedButton&&e.speedButton.parentNode.removeChild(e.speedButton),e.speedSelector&&e.speedSelector.parentNode.removeChild(e.speedSelector))}});
 //# sourceMappingURL=/sm/8c9ae1b7645fa2be9b4c2b5328ec27108c3c822be560deb00b61ee4242248b95.map