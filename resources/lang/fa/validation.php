...
return [
    ...
    */
    ...
    'ends_with'            => ':attribute باید با یکی از موارد زیر. :values به پایان برسد.',
    ...
    'name'                  => 'نام الزامی باشد ونباید تکراری باشد.',
    'brand_id'              => 'نام برند الزامی باشد.',
    'category_id'           => 'نام دسته الزامی باشد.',
    'size_tile'             => 'سایز سرامیک الزامی و باید عددی وارد شود.',
    'size_box'              => 'سایز جعبه الزامی و باید عددی وارد شود.',
    /*'image'                 => 'تصویر الزامی و فرمت آن باید jpg باشد.',*/
    ...
    */
    ...
    'attributes' => [
        ...
        'color'                 => 'رنگ',
        'degree '               => 'درجه',
        'parent_id'             => 'انتخاب سر دسته',
        'brand_id'              => 'برند',
        'category_id'           => 'دسته',
        'size_id'               => 'سایز سرامیک',
        'size_box'              => 'سایز جعبه',
        'tile_size'              => 'سایز سرامیک',
        'colors'                => 'رنگ',
        'captcha'               => 'کد امنیتی',
        'degree[]'               => 'درجه',
