        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('podcategory.store')}}">
                        {{csrf_field()}}
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">مدیریت دسته بندی پادکست ها</h4>
                    </div>
                                    ...
                                    @foreach($categories as $category)
                                        <tr >
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-warning" href="{{route('podcategory.edit', $category->id)}}">ویرایش</a>
                                            </td>
                                            <td class="text-center">
                                                <form  method="post" action="{{route('podcategory.destroy', $category->id)}}">
                                                    @csrf
