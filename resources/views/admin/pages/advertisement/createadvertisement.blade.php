        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="box-title pull-right">ایجاد محتوای جدید </h3>
                </div>
                                ...
                                <div class="card-content">
                                    <div class="card-body" id="button">
                                        <div class="row col-md-12">
                                            ...
                                            <form class="col-md-12" method="post" action="{{route('advertisement.store')}}" enctype="multipart/form-data">
                                                {{csrf_field()}}
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-xl-6 col-md-6 col-12 mb-1">
                                                                                <fieldset class="form-group">
                                                                                    ...
                                                                                    <input type="text" name="title" class="form-control" placeholder="عنوان پروژه را وارد کنید..." >
                                                                                </fieldset>
                                                                            </div>
                                                                            <div class="col-xl-6 col-md-6 col-12 mb-1">
                                                                                <fieldset class="form-group">
                                                                                    <label for="name">نوع محتوا</label>
                                                                                    <input type="text" name="category" class="form-control" placeholder="نوع محتوا را وارد کنید..." >
                                                                                </fieldset>
                                                                            </div>
                                                                            <div class="col-xl-6 col-md-6 col-12 mb-1">
                                                                                <fieldset class="form-group">
                                                                            ...
                                                                            <div class="col-xl-6 col-md-6 col-12 mb-1">
                                                                                <fieldset class="form-group">
                                                                                    ...
                                                                                    <input type="text" name="client" class="form-control" placeholder="نام مشتری/شرکت را وارد کنید..." >

                                                                                </fieldset>
                                                                            </div>
                                                                            <div class="col-xl-6 col-md-6 col-12 mb-1">
                                                                                <fieldset class="form-group">
                                                                                    <label for="img">تیزر معرفی</label>
                                                                                    <input type="file" name="file" class="form-control" placeholder="تصویر معرفی را از درون رایانه خود انتخاب کنید...">
