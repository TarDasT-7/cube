        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="box-title pull-right">ویرایش مقاله: {{$blog->id}}</h3>
                </div>
                                ...
                                <div class="card-content">
                                    <div class="card-body" id="button">
                                        <div class="row col-md-12">
                                            <form class="col-md-12" method="post" action="{{route('blog.update', $blog->id)}}">
                                                @method('PATCH')
                                                {{csrf_field()}}
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-xl-6 col-md-6 col-12 mb-1">
                                                                                <fieldset class="form-group">
                                                                                    ...
                                                                                    <input type="text" name="title" class="form-control" placeholder="عنوان دوره را وارد کنید..." value="{{$blog->title}}">
                                                                                </fieldset>
                                                                            </div>
                                                                            <div class="col-xl-6 col-md-6 col-12 mb-1">
                                                                                <fieldset class="form-group">
                                                                            ...
                                                                            <div class="col-xl-6 col-md-6 col-12 mb-1">
                                                                                <fieldset class="form-group">
                                                                                    ...
                                                                                    <input type="file" name="image" class="form-control" placeholder="تصویر معرفی را از درون رایانه خود انتخاب کنید..." value="{{$blog->image}}">
                                                            ...
                                                            <div class="card-content">
                                                                <div class="card-body">
                                                                    <div class="table-responsive">
                                                                        <textarea class="form-control" id="summary-ckeditor" name="description" >{{$blog->desc}}</textarea>
