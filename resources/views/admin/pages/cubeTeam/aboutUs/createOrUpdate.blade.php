        ...
        <div class="row" id="table-striped">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    @elseif($rel == 'update')
                    <form method='post' action="{{route('aboutUs.update' , $about->id)}}"  enctype="multipart/form-data">
                        @method('patch')
                        @csrf
                        <div class="card-header">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <label>عنوان</label>
                                            <input type="text" name="title" class="form-control" value="{{$about->title}}" placeholder="عنوان خود را وارد کنید">        
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <label>متن</label>
                                            <textarea class="form-control" id="summary-ckeditor3" name="description">{{$about->description}}</textarea>
                                            <script src="{{ asset('ckeditor/ckeditor.js') }}"></script>
                                            <script>
                                                CKEDITOR.replace( 'summary-ckeditor3', {
                                                    filebrowserUploadUrl: "{{route('upload', ['_token' => csrf_token() ])}}",
