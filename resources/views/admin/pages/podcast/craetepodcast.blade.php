        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="box-title pull-right">ایجاد پادکست جدید </h3>
                </div>
                                ...
                                <div class="card-content">
                                    <div class="card-body" id="button">
                                        <div class="row col-md-12">
                                            <form class="col-md-12" method="post" action="{{route('podcast.store')}}" enctype="multipart/form-data">
                                                {{csrf_field()}}
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-xl-6 col-md-6 col-12 mb-1">
                                                                                <fieldset class="form-group">
                                                                                    ...
                                                                                    <select class="select2-bg form-control" name="speaker" id="bg-select" data-bgcolor="success" data-bgcolor-variation="lighten-3" data-text-color="white">
