        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">اضافه کردن فایل محصول</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="post" action="{{route('product_video.store')}}" enctype="multipart/form-data">
                        {{csrf_field()}}

                        <div class="col-md-12  mb-1">
                            <fieldset class="form-group">
                                <label for="basicInput">عنوان فایل</label>
                                <input type="text" name="title" class="form-control" id="basicInput" placeholder="عنوان فایل">
                            </fieldset>
                        </div><div class="col-md-12  mb-1">
                            <fieldset class="form-group">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="example" class="table table-striped ">
                                    <thead>
                                    <tr id="add">
                                        <th scope="col" class="text-center"> عنوان فایل </th>
                                    ...
                                    @foreach($files as $file)
                                        <tr >
                                            ...
                                            <td class="text-center">{{$file->product->name}}</td>
                                            <td class="text-center">
                                                <a class="btn btn-warning" href="{{route('product_video.edit', $file->id)}}">ویرایش</a>
                                            </td>
                                            <td class="text-center">
                                                <form  method="post" action="{{route('product_video.destroy', $file->id)}}">
                                                    @csrf
