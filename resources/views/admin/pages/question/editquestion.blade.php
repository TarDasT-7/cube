        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="box-title pull-right">ویرایش سوال و جواب: {{$question->id}}</h3>
                </div>
                                ...
                                <div class="card-content">
                                    <div class="card-body" id="button">
                                        <div class="row col-md-10">
                                            ...
                                            <form class="col-md-6" method="post" action="{{route('question.update', $question->id)}}">
                                                @csrf
                                                @method('PATCH')
                                                ...
                                                <div class="row" id="table-striped">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="table-responsive">
                                                            <textarea class="form-control" id="summary-ckeditor" name="answer">{{$question->answer}}</textarea>
                                                ...
                                                <button type="submit" class="btn btn-success pull-left mt-1">به روز رسانی</button>
                                            </form>
