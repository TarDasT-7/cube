        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">ایجاد سوال و جواب </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="post" action="{{route('questioncategory.store')}}">
                        {{csrf_field()}}
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">مدیریت دسته بندی سوالات</h4>
                    </div>
                                    ...
                                    @foreach($categories as $category)
                                        <tr >
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-warning" href="{{route('questioncategory.edit', $category->id)}}">ویرایش</a>
                                            </td>
                                            <td class="text-center">
                                                <form  method="post" action="{{route('questioncategory.destroy', $category->id)}}">
                                                    @csrf
