        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="box-title pull-right">ویرایش گوینده: {{$speaker->id}}</h3>
                </div>
                                ...
                                <div class="card-content">
                                    <div class="card-body" id="button">
                                        <div class="row col-md-10">
                                            ...
                                            <form class="col-md-6" method="post" action="{{route('speaker.update', $speaker->id)}}">
                                                @csrf
                                                @method('PATCH')
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        <input type="text" name="specialty" class="form-control" id="basicInput" value="{{$speaker->specialty}}">
                                                </div>
