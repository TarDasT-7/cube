        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">ایجاد سمت جدید</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-12  mb-1">
                            <fieldset class="form-group">
                                ...
                                <input type="text" name="role" class="form-control" placeholder="عنوان مورد نظر خود را وارد کنید">
                            </fieldset>
                        </div>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">لیست سمت ها</h4>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table id="example" class="table table-striped ">
                                    ...
                                    <tr id="add">
                                        ...
                                        <th scope="col" class="text-center">اعضای دارای سمت</th>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="col-md-12  mb-1">
                                                                <fieldset class="form-group">
                                                                    ...
                                                                    <input type="text" name="role" class="form-control" value="{{$role->title}}" placeholder="عنوان مورد نظر خود را وارد کنید">
                                                                </fieldset>
                                                            </div>
