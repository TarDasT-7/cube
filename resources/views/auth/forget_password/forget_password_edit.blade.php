    ...
    <div class="container-fluid reg_cont pt-5 pb-6 cuclb_cont ">
        ...
        <div class="row reg_formrow justify-content-center">
            <div class="col-12 col-md-4 purchase_successcol rgform_col back_gray">
                ...
                <div class="row title_row_rg">
                    <div class="col-md-12 title_col_rg ">
                        <h6 class="txt_srmp pb-3 text-center bbj">لطفا رمز عبور جدید خود را وارد نمایید.</h6>
                        <h6 class="txt_srmp pb-3 text-center bbj">رمز عبور شما باید حداقل شامل 6 کاراکتر باشد</h6>
                    </div>
                </div>
                <div class="row rg_form m-0">
                    <div class="col-12 col-md-12 rg_form_col">
                        <form id="comment_form"  method="post" action="{{ url('forget_password_pass') }}" role="form" class="row user_rating_row ">
                            @csrf
                            <input type="hidden" name="pass" value="{{$pass->phone}}">
