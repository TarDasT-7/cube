            ...
            <div class="col-12 col-md-4 purchase_successcol rgform_col back_gray">
                <div class="row title_row_rg">
                    <div class="col-md-12 title_col_rg ">
                        <h4 class="txt_srmp pb-3 text-center bbj">کد تایید را وارد نمایید</h4>
                    </div>
                </div>
                <div class="row title_row_rg">
                    <div class="col-md-12 title_col_rg ">
                        <h6 class="txt_srmp pb-3 text-center bbj">کد تایید برای شماره موبایل {{$pass->phone}} ارسال گردید</h6>
                    </div>
                </div>
                <div class="row rg_form m-0">
                    <div class="col-12 col-md-12 rg_form_col">
                        <form id="comment_form"  method="post" action="{{ url('forget_password_token') }}" role="form" class="row user_rating_row ">
                            @csrf
                            ...
                            <div class="form-group col-12 col-md-12">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input id="token" name="token" class="form-control srch_cus3 txt_gray mr-0" type="number" placeholder="کد ارسالی را وارد کنید">
