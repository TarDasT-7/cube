...
<section class="container-fluid prtfil_mainsec pb-5 mb-5">
    <div class="row blgmntit_row justify-content-center">
         <div class="col-md-8 blgmntit_col m-auto">
               <h1 class="bbj bold frvid_tit txt_grdrk">فیلم های آموزشی</h1>
           </div>
    </div>
               ...
               <div class="col-md-12 prjct_cont">
                       <div class="row prjcts_prv_mrow  m-0 itemAdding">
                            @foreach ($videos as $video)
                                ...
                                <div class="frvid_lipr_col col-md-3 hideItems">
                                        ...
                                        <div class="row frvidlist_pr_row  ">
                                            ...
                                            <div class="row pdcst_dts_row m-0">
                                                <div class="col-12 col-md-12 pdcst_dt_col feature_dt_col">
                                                    <h6 class="font14 txt_dgray bold">{{$video->title}}</h6>
                                                </div>
                                                <div class="col-12 col-md-12 pdcst_dt_col feature_dt_col ">
                                                    <ul class="list-unstyled list-inline  pr-0 tch_dtul mb-0">
                                                    <li class=" list-inline-item tch_dtulli">
                                                        <span class="txt_gray font13">{{$video->producer->first_name}} {{$video->producer->last_name}}</span>
                                                    </li>
                                                    <li class="list-inline-item tch_dtulli float-left">
                                                        <span class="txt_gray font13"> {{$video->time}} <i class="far fa-clock pr-1 font13"></i></span>
                                                    </li>
                                                </ul>
                                                </div>
            ...
            success: function (response) {
                ...
                if(response.length > 0)
                {
                    ...
                    for(var i = 0 ; i < response.length ; i++)
                    {
                        items +=
                                `
                                    <div class="frvid_lipr_col col-md-3 removeItems">
                                        <a href="free-video-show-`+response[i].id+`" class="txt_dgray">
                                            <div class="row frvidlist_pr_row  ">
                                                <div class="col-12 col-md-12 frvid_imgcol pb-2 text-center">
                                                <img class="frvid_img" src="/images/free/`+ response[i].cover +`">
                                                    <svg class="frvid_icocol" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                                                viewBox="0 0 109.126 109.126" style="enable-background:new 0 0 109.126 109.126;" xml:space="preserve">
                                                            <g>
                                                            <path d="M98.901,47.663L18.197,1.068c-2.467-1.424-5.502-1.424-7.972,0C7.762,2.491,6.243,5.124,6.243,7.971v93.188
                                                ...
                                                <div class="row pdcst_dts_row m-0">
                                                    ...
                                                    <div class="col-12 col-md-12 pdcst_dt_col feature_dt_col ">
                                                        <ul class="list-unstyled list-inline  pr-0 tch_dtul mb-0">
                                                        <li class=" list-inline-item tch_dtulli">
                                                            <span class="txt_gray font13">`+response[i].producer['first_name']+` `+response[i].producer['last_name']+`</span>
                                                        </li>
                                                        <li class="list-inline-item tch_dtulli float-left">
                                                            <span class="txt_gray font13"> `+ response[i].time +` <i class="far fa-clock pr-1 font13"></i></span>
                                                        </li>
                                                    </ul>
                                                    </div>
